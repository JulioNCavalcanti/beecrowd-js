...
let tempoGastoNaViagem = parseInt(lines.shift());
let velocidadeMediaDuranteAViagem = parseInt(lines.shift());

let quantidadeDeLitrosNecessaria = (tempoGastoNaViagem * velocidadeMediaDuranteAViagem) / 12;

console.log(quantidadeDeLitrosNecessaria.toFixed(3));