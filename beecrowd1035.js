...
let A = parseInt(informacoesDaLinha1.shift());
let B = parseInt(informacoesDaLinha1.shift());
let C = parseInt(informacoesDaLinha1.shift());
let D = parseInt(informacoesDaLinha1.shift());
