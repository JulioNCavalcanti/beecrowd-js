...
let numeroDeHorasTrabalhadas = parseInt(lines.shift());
let valorQueRecebePorHora = parseFloat(lines.shift());
let salario = numeroDeHorasTrabalhadas * valorQueRecebePorHora;
